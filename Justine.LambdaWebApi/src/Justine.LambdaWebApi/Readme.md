...
* LambdaEntryPoint.cs - class that derives from **Amazon.Lambda.AspNetCoreServer.APIGatewayProxyFunction**. 
  The code in this file bootstraps the ASP.NET Core hosting framework. 
The Lambda function is defined in the base class.
...
Execute unit tests
```
    cd "Justine.LambdaWebApi/test/Justine.LambdaWebApi.Tests"
    dotnet test
```
